...
export const metadata: Metadata = { title: "Gizlilik Politikası", description: "Derslinex gizlilik politikası ve KVKK aydınlatma metni." };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose max-w-none text-gray-700 space-y-6">
        ...
        {[
          ["1. Veri Sorumlusu", "Derslinex ('Platform'), 6698 sayılı Kişisel Verilerin Korunması Kanunu ('KVKK') kapsamında veri sorumlusudur."],
