      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-24">
            {/* Foto */}
            <div className="bg-gradient-to-b from-primary-600 to-primary-400 p-8 flex flex-col items-center">
              <div className="relative w-28 h-28 rounded-full overflow-hidden ring-4 ring-white mb-4">
              ...
              <p className="text-blue-100 text-sm mt-1">{hoca.unvan}</p>
            </div>
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold">{hoca.ogrenciSayisi}+</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500">Deneyim</span>
                <span className="font-semibold">{hoca.deneyimYili} yıl</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500">Format</span>
                <span className="font-semibold">{formatLabel[hoca.format]}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500">Konum</span>
                <span className="font-semibold text-right">{hoca.konum}</span>
              </div>

              {/* YKS Türleri */}
              <div className="pt-2">
                <p className="text-xs text-gray-500 mb-2">YKS Türleri</p>
                <div className="flex flex-wrap gap-1.5">
                  {hoca.yksTuru.map((t) => (
                    <span key={t} className="text-xs bg-primary-50 text-primary-700 font-medium px-2.5 py-1 rounded-full">
                      {t}
                    </span>
                  ))}
                </div>
              ...
              <div className="pt-1">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {hoca.dersler.map((d) => (
                    <span key={d} className="text-xs bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full">
                      {d}
                    </span>
                  ))}
                </div>
            ...
            <div className="p-5 pt-0 space-y-2">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3.5 rounded-xl transition-colors text-sm"
              >
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Mezuniyet Yılı: {new Date().getFullYear() - hoca.deneyimYili - 4} (tahmini)</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={s.lbl} className="bg-primary-50 rounded-2xl p-4 text-center">
            ...
            {(hoca.format === "her-ikisi" || hoca.format === "yuz-yuze") && (
              <div className="flex items-start gap-3 mb-4 p-4 bg-blue-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Konum: {hoca.konum}</p>
                </div>
              </div>
            )}
            {(hoca.format === "her-ikisi" || hoca.format === "online") && (
              <div className="flex items-start gap-3 p-4 bg-green-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Google Meet veya Zoom üzerinden canlı ders</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-500 rounded-2xl p-6 text-white text-center">
            <h3 className="text-xl font-bold mb-2">{hoca.isim} ile Ders Almak İster misin?</h3>
            <p className="text-green-100 text-sm mb-5">WhatsApp üzerinden hemen iletişime geç, müsaitlik ve ücret konuşun.</p>
            <a
              href={waUrl}
              target="_blank"
              rel="noopener noreferrer"
