...
export const metadata: Metadata = { title: "Kullanım Koşulları", description: "Derslinex platformu kullanım koşulları." };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose max-w-none text-gray-700 space-y-6">
        ...
        {[
          ["1. Hizmet Kapsamı", "Derslinex, YKS hazırlık amaçlı öğrenci-hoca eşleşme platformudur. Platform, ders içeriğinden değil aracılık hizmetinden sorumludur."],
          ...
          ["3. Fikri Mülkiyet", "Platform üzerindeki tüm içerikler (metin, görseller, tasarım) Derslinex'e aittir. İzinsiz kopyalanamaz."],
