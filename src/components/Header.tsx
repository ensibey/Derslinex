      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="relative w-8 h-8 rounded-lg overflow-hidden border border-primary-100 shadow-sm group-hover:scale-105 transition-transform">
              <Image
                src="/logo.png"
                alt="Derslinex Logo"
                fill
            ...
            <span className="text-2xl font-black text-primary-600 tracking-tight">Derslinex</span>
          </Link>
          ...
          <div className="px-4 py-3 space-y-2">
            {navLinks.map((l) => (
              <Link
                ...
                className="block px-3 py-2 text-gray-700 font-medium hover:bg-gray-50 rounded-lg"
              >
                {l.label}
              </Link>
            ))}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 mt-2 bg-green-600 text-white font-semibold py-3 rounded-lg"
            >
              WhatsApp ile Ders Al
            </a>
          </div>
