        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-semibold mt-0.5">
              Canlı, sessiz ve yüksek odaklanmalı dijital çalışma kütüphanesi
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-emerald-400 font-bold flex items-center gap-1 mt-0.5">
                  ...
                  Canlı Sessiz Çalışma Akışı Aktif
                </span>
              </div>
            </div>
          ...
          <div>
            <h5 className="text-xs font-black uppercase tracking-wider text-slate-400 mb-3">
              Çalışma Masanız (Canlı Odaklanma Odası)
            </h5>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Me Card */}
              <div className="bg-gradient-to-br from-indigo-900/40 via-[#0D1B35] to-[#1E293B] border-2 border-indigo-500 rounded-2xl p-6 flex flex-col items-center justify-center relative shadow-lg text-center min-h-[160px]">
                <span className="absolute top-3 right-3 text-[10px] font-black bg-indigo-500 text-white px-2.5 py-0.5 rounded-full">
                  SİZ (AKTİF)
                </span>
                ...
                <span className="font-black text-white text-sm">Aktif Çalışma Oturumu</span>
                <span className="text-xs text-emerald-400 font-bold flex items-center gap-1 mt-1">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                  Sessizce Odaklanılıyor
                </span>
              </div>

              {/* Information Panel */}
              <div className="bg-[#0D1B35] border border-white/10 rounded-2xl p-6 flex flex-col justify-center space-y-2">
                <h6 className="font-black text-white text-xs uppercase tracking-wider">💡 Çalışma Odası Kuralları</h6>
                <p className="text-xs text-slate-400 leading-relaxed font-semibold">
                  Bu oda yüksek odaklanma için tasarlanmıştır. Sayacınızı başlatıp ders çalışmanıza odaklanabilirsiniz. Diğer öğrenciler katıldıkça çalışma masalarında görüntülenecektir.
                </p>
              </div>
            </div>
          </div>
