export const SITE_NAME = "Sadee Eğitim";
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://www.sadee.com.tr";
export const WA_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "905550000000";
