...
export const hocalar: Hoca[] = [
  {
    id: "1",
    slug: "ahmet-yilmaz-matematik",
    isim: "Ahmet Yılmaz",
    unvan: "Uzm. Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=AhmetYilmaz&eyebrows=default&mouth=smile",
  ...
  {
    id: "2",
    slug: "elif-demir-turkce-edebiyat",
    isim: "Elif Demir",
    unvan: "Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=ElifDemir&eyebrows=defaultNatural&mouth=smile",
    dersler: ["Türkçe", "Türk Dili ve Edebiyatı"],
  ...
  {
    id: "3",
    slug: "mehmet-celik-fizik",
    isim: "Dr. Mehmet Çelik",
    unvan: "Dr.",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=MehmetCelik&eyebrows=default&mouth=smile",
    dersler: ["Fizik"],
    yksTuru: ["TYT", "AYT Sayısal"],
    format: "online",
    konum: "Türkiye Geneli (Online)",
    deneyimYili: 10,
  ...
  {
    id: "4",
    slug: "zeynep-arslan-kimya-biyoloji",
    isim: "Zeynep Arslan",
    unvan: "Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=ZeynepArslan&eyebrows=defaultNatural&mouth=smile",
  ...
  {
    id: "5",
    slug: "can-sahin-tarih-cografya",
    isim: "Can Şahin",
    unvan: "Uzm. Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=CanSahin&eyebrows=default&mouth=smile",
    dersler: ["Tarih", "Coğrafya", "T.C. İnkılap Tarihi"],
    yksTuru: ["TYT", "AYT Sözel", "AYT EA"],
    format: "her-ikisi",
    konum: "Çankaya, Ankara / Online",
    deneyimYili: 7,
  ...
  {
    id: "6",
    slug: "selin-kaya-ingilizce",
    isim: "Selin Kaya",
    unvan: "Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=SelinKaya&eyebrows=defaultNatural&mouth=smile",
    dersler: ["İngilizce (YDT)"],
    yksTuru: ["TYT", "AYT Dil"],
    format: "her-ikisi",
  ...
  {
    id: "7",
    slug: "burak-aydin-matematik-tyt",
    isim: "Burak Aydın",
    unvan: "Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=BurakAydin&eyebrows=default&mouth=smile",
    dersler: ["Matematik", "Geometri"],
    yksTuru: ["TYT"],
    format: "online",
    konum: "Türkiye Geneli (Online)",
  ...
  {
    id: "8",
    slug: "ayse-ozdemir-felsefe",
    isim: "Ayşe Özdemir",
    unvan: "Uzm. Öğretmen",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=AyseOzdemir&eyebrows=defaultNatural&mouth=smile",
    dersler: ["Felsefe", "Psikoloji", "Sosyoloji", "Mantık"],
  ...
  {
    id: "9",
    slug: "kemal-turk-kimya",
    isim: "Kemal Türk",
    unvan: "Dr.",
    fotograf: "https://api.dicebear.com/7.x/avataaars/svg?seed=KemalTurk&eyebrows=default&mouth=smile",
    dersler: ["Kimya"],
    yksTuru: ["TYT", "AYT Sayısal"],
    format: "her-ikisi",
    konum: "Bornova, İzmir",
