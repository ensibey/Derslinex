...
export const blogYazilari: BlogYazisi[] = [
  {
    ...
    icerik: `YKS matematiği iki temel aşamadan oluşur: TYT (Temel Yeterlilik Testi) ve AYT (Alan Yeterlilik Testi). Bu iki sınav, yapısı ve ölçtüğü beceriler açısından birbirinden oldukça farklıdır. <a href="/ogretmenler?alan=Matematik" class="text-[#B45309] font-bold hover:underline">TYT Matematik</a> daha çok mantıksal akıl yürütme, problem çözme hızı ve temel matematiksel kavramları günlük hayat senaryolarına uygulama becerisini ölçerken; <a href="/ogretmenler?alan=Matematik" class="text-[#B45309] font-bold hover:underline">AYT Matematik</a> ise derinlemesine formül bilgisi, teorik analiz ve akademik matematik yeteneğini sorgular.
